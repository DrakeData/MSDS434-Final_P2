...
with st.container():
    ...
    analytics application that is hosted on the Google Cloud Platform (GCP). The GitHub repository for this project with the technical documentation can be 
    [found here](https://github.com/DrakeData/MSDS434-Final_P2).''')
    st.subheader("Project was created by Nicholas Drake")
    st.image(img_nd)
